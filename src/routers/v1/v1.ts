...
import paidLeaveRouter from '../paidLeaveRequest/paidLeaveRequest.router';
...
import safetyCheckRouter from '../safetyCheck/safetyCheck.router';
import eventCheckRouter from '../eventCheck/eventCheck.router';
...
v1Router.use('/eventcheck', eventCheckRouter);
