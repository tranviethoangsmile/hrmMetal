import { createFoodInterface } from '../../interfaces/food/food.interface';
import {
    create_food,
    find_food_by_id,
    get_all_food,
} from '../../repositorys/food/food.repository';
import { validate_food_create } from '../../validates/food/food.validate';
