...
import { createTaxDependentController, deleteTaxDependentWithIdController, updateTaxDependentWithIdController, getTaxDependentByUserIdController } from './taxDependent/taxDependent.controller';
export {
    createDep,
    departmentList,
    getDepartmentById,
