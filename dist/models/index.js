...
exports.DependentSupportAmount = exports.TaxDependent = exports.OvertimeRequest = exports.DayOffs = exports.SafetyReport = exports.UniformOrder = exports.DeleteConversation = exports.FcmToken = exports.DeleteMessage = exports.Notification = exports.PlanProduction = exports.Payroll = exports.EventChecks = exports.SafetyChecks = exports.Events = exports.Inventory = exports.Information = exports.Checkin = exports.Conversation = exports.GroupMember = exports.Message = exports.PaidLeaveRequest = exports.Trainning = exports.Product = exports.CodeError = exports.DailyReport = exports.Order = exports.Food = exports.Canteen = exports.Department = exports.User = void 0;
...
const uniformOrder_model_1 = __importDefault(require("./uniformOrder.model"));
exports.UniformOrder = uniformOrder_model_1.default;
const safetyReport_model_1 = __importDefault(require("./safetyReport.model"));
exports.SafetyReport = safetyReport_model_1.default;
const dayOffs_model_1 = __importDefault(require("./dayOffs.model"));
exports.DayOffs = dayOffs_model_1.default;
const overtimeRequests_model_1 = __importDefault(require("./overtimeRequests.model"));
exports.OvertimeRequest = overtimeRequests_model_1.default;
const taxDependent_model_1 = __importDefault(require("./taxDependent.model"));
exports.TaxDependent = taxDependent_model_1.default;
const dependentSupportAmount_model_1 = __importDefault(require("./dependentSupportAmount.model"));
exports.DependentSupportAmount = dependentSupportAmount_model_1.default;
...
uniformOrder_model_1.default.belongsTo(user_model_1.default, { foreignKey: 'user_id' });
user_model_1.default.hasMany(uniformOrder_model_1.default, { foreignKey: 'user_id' });
safetyReport_model_1.default.belongsTo(user_model_1.default, { foreignKey: 'user_id', as: 'userDetail' });
user_model_1.default.hasMany(safetyReport_model_1.default, { foreignKey: 'user_id' });
safetyReport_model_1.default.belongsTo(user_model_1.default, { foreignKey: 'leader_id', as: 'leaderDetail' });
user_model_1.default.hasMany(safetyReport_model_1.default, { foreignKey: 'leader_id' });
user_model_1.default.hasMany(dayOffs_model_1.default, { foreignKey: 'user_id' });
dayOffs_model_1.default.belongsTo(user_model_1.default, { foreignKey: 'user_id', as: 'userDetail' });
overtimeRequests_model_1.default.belongsTo(department_model_1.default, {
    foreignKey: 'department_id',
    as: 'departmentDetail',
});
department_model_1.default.hasMany(overtimeRequests_model_1.default, { foreignKey: 'department_id' });
user_model_1.default.hasMany(overtimeRequests_model_1.default, { foreignKey: 'user_id' });
user_model_1.default.hasMany(overtimeRequests_model_1.default, { foreignKey: 'leader_id' });
user_model_1.default.hasMany(overtimeRequests_model_1.default, { foreignKey: 'admin_id' });
overtimeRequests_model_1.default.belongsTo(user_model_1.default, { foreignKey: 'user_id', as: 'userDetail' });
overtimeRequests_model_1.default.belongsTo(user_model_1.default, {
    foreignKey: 'leader_id',
    as: 'leaderDetail',
});
overtimeRequests_model_1.default.belongsTo(user_model_1.default, { foreignKey: 'admin_id', as: 'adminDetail' });
user_model_1.default.hasMany(taxDependent_model_1.default, { foreignKey: 'user_id', as: 'taxDependents' });
taxDependent_model_1.default.belongsTo(user_model_1.default, { foreignKey: 'user_id', as: 'userDetail' });
dependentSupportAmount_model_1.default.belongsTo(taxDependent_model_1.default, { foreignKey: 'tax_dependent_id', as: 'taxDependentDetail' });
taxDependent_model_1.default.hasMany(dependentSupportAmount_model_1.default, { foreignKey: 'tax_dependent_id', as: 'taxDependentDetail' });
dependentSupportAmount_model_1.default.belongsTo(user_model_1.default, { foreignKey: 'user_id', as: 'userDetail' });
user_model_1.default.hasMany(dependentSupportAmount_model_1.default, { foreignKey: 'user_id', as: 'userDetail' });
