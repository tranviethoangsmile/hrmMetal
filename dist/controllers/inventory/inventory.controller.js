...
exports.update_inventory_controller = exports.get_all_inventory_controller = exports.search_inventory_with_name_controller = exports.create_inventory_controller = void 0;
const inventory_useCase_1 = require("../../useCases/inventory/inventory.useCase");
const create_inventory_controller = (field) => __awaiter(void 0, void 0, void 0, function* () {
    return yield (0, inventory_useCase_1.create_inventory_use)(field);
});
exports.create_inventory_controller = create_inventory_controller;
