...
exports.check_picked_order = exports.search_order_of_user = exports.delete_order = exports.search_orders = exports.find_all_order = exports.create = void 0;
const order_useCase_1 = require("../../useCases/order/order.useCase");
...
const check_picked_order = (field) => __awaiter(void 0, void 0, void 0, function* () {
    return yield (0, order_useCase_1.checkin_picked)(field);
});
