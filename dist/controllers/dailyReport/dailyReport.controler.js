...
const dailyReport_useCase_1 = require("../../useCases/dailyReport/dailyReport.useCase");
const daily_report_create = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return yield (0, dailyReport_useCase_1.create_daily_report_use)(data);
});
exports.daily_report_create = daily_report_create;
const find_all_report = (field) => __awaiter(void 0, void 0, void 0, function* () {
    return yield (0, dailyReport_useCase_1.find_all_report_use)(Object.assign({}, field));
});
