...
deleteMessageRouter.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!field || !(field === null || field === void 0 ? void 0 : field.message_id) || !field.user_id) {
            return (0, helpers_1.errorResponse)(res, 400, 'Missing required fields: message_id and user_id');
        }
        const result = yield (0, controllers_1.create_delete_message_cotroller)(field);
        if (!(result === null || result === void 0 ? void 0 : result.success)) {
            return (0, helpers_1.errorResponse)(res, 400, (result === null || result === void 0 ? void 0 : result.message) || 'Failed to delete message');
        }
        return (0, helpers_1.successResponse)(res, 200, undefined, 'Message deleted successfully');
    }
    catch (error) {
