...
const updateUnApproveLeave_router_1 = __importDefault(require("./update/updateUnApproveLeave.router"));
const updateConfirmLeave_router_1 = __importDefault(require("./update/updateConfirmLeave.router"));
...
paidLeaveRouter.use('/update', updateUnApproveLeave_router_1.default);
paidLeaveRouter.use('/updateconfirm', updateConfirmLeave_router_1.default);
