...
const create_group_conversation_router_1 = __importDefault(require("./create_group/create_group.conversation.router"));
...
conversationRouter.use('/creategroup', create_group_conversation_router_1.default);
