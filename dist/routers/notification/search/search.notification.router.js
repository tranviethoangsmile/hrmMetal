...
searchNotificationRouter.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!(notification === null || notification === void 0 ? void 0 : notification.success)) {
            return (0, helpers_1.errorResponse)(res, 200, (notification === null || notification === void 0 ? void 0 : notification.message) || 'Notification not found');
        }
        return (0, helpers_1.successResponse)(res, 202, notification === null || notification === void 0 ? void 0 : notification.data);
    }
    catch (error) {
