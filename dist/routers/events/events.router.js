...
const getWithPostition_router_1 = __importDefault(require("./getWithPosition/getWithPostition.router"));
...
eventsRouter.use('/getwithposition', getWithPostition_router_1.default);
