...
const getEventsWithPositionRouter = (0, express_1.Router)();
getEventsWithPositionRouter.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const position = req.body.position;
        if (!position) {
            return (0, helpers_1.errorResponse)(res, 400, 'position is required');
        }
        const events = yield (0, controllers_1.get_events_with_position_controller)(position);
...
exports.default = getEventsWithPositionRouter;
