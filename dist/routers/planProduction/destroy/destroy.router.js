...
destroyPlanProductionRouter.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!(result === null || result === void 0 ? void 0 : result.success)) {
            return (0, helpers_1.errorResponse)(res, 200, (result === null || result === void 0 ? void 0 : result.message) || 'Failed to delete plan production');
        }
        return (0, helpers_1.successResponse)(res, 202, undefined, 'Plan production deleted successfully');
    }
    catch (error) {
