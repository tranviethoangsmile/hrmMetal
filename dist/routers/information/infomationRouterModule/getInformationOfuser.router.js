...
getInforOfUserRouter.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!user_id) {
            return (0, helpers_1.errorResponse)(res, 400, 'Missing parameter: user_id');
        }
        else {
            ...
            if (informations === null || informations === void 0 ? void 0 : informations.success) {
                ...
                return (0, helpers_1.errorResponse)(res, 400, (informations === null || informations === void 0 ? void 0 : informations.message) || 'Failed to get information');
            }
        }
    }
    catch (error) {
