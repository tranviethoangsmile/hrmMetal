...
checkinDetailRouter.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const checkin_detail = yield (0, controllers_1.get_checkin_detail_in_date_of_user_controller)(field);
        if (!(checkin_detail === null || checkin_detail === void 0 ? void 0 : checkin_detail.success)) {
            return (0, helpers_1.errorResponse)(res, 200, checkin_detail === null || checkin_detail === void 0 ? void 0 : checkin_detail.message);
        }
        return (0, helpers_1.successResponse)(res, 202, checkin_detail === null || checkin_detail === void 0 ? void 0 : checkin_detail.data);
    }
    catch (error) {
