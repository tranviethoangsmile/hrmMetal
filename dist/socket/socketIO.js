...
const init = (server) => {
    ...
    io.on('connection', (socket) => {
        ...
        socket.on('un_send_message', ({ message_id, conversation_id, }) => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield (0, controllers_1.unSend_message_with_id_controller)(message_id);
        ...
        socket.on('delete_message', ({ message_id, user_id, conversation_id, }) => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield (0, controllers_1.create_delete_message_cotroller)({
