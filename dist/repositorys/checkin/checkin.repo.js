...
class CheckinRepository {
    ...
    GET_ALL_CHECKINS_OF_POSITION_IN_DATE_FOR_ADMIN(date, position) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const checkins = yield models_1.Checkin.findAndCountAll({
                    where: {
                        date: date,
                        is_paid_leave: false,
                        position: position,
    ...
    GET_ALL_PAID_LEAVE_OF_POSITION_IN_DATE_FOR_ADMIN(date, position) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const paid_leaves = yield models_1.Checkin.findAndCountAll({
                    where: {
                        date: date,
                        is_paid_leave: true,
                        position: position,
