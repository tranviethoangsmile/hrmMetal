...
const department_repository_1 = require("../repositorys/department.repository");
const department_validate_1 = require("../validates/department.validate");
...
const departmentCreate = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!valid.error) {
            const newDepartment = yield (0, department_repository_1.createDepartment)(data);
...
const getDepartmentList = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const departments = yield (0, department_repository_1.departmentList)();
...
const getDepById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!validId.error) {
            const department = yield (0, department_repository_1.getDepartmentById)(id);
