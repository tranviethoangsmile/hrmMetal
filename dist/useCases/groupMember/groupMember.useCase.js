...
const create_groupMember = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!(0, helpers_1.isValidEnumValue)(data.role, enum_1.groupMemberRole)) {
            throw new Error('Invalid role');
        }
        if (typeof data.group_type !== 'string' || !Object.keys(enum_1.GR_TYPE).includes(data.group_type)) {
            throw new Error(`Invalid group_type`);
        }
