...
const create_information_use = (value) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!(0, helpers_1.isValidEnumValue)(info_value.position, enum_1.Position)) {
        ...
        yield (0, utils_1.delCache)(`information_user_${info_value.user_id}`);
        return {
            success: true,
...
const search_information_of_user_use = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const information_value_of_user = yield (0, utils_1.getCache)(KEY_CACHE);
        ...
        yield (0, utils_1.setCache)(KEY_CACHE, JSON.stringify(informations === null || informations === void 0 ? void 0 : informations.data), 86400);
        return {
...
const search_all_information_with_field_use = (field) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const information_value = yield (0, utils_1.getCache)(KEY_CACHE);
