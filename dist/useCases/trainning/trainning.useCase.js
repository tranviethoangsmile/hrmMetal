...
const trainning_repository_1 = require("../../repositorys/trainning/trainning.repository");
const user_useCase_1 = require("../user/user.useCase");
const product_enum_1 = require("../../enum/product.enum");
const trainning_validate_1 = require("../../validates/trainning/trainning.validate");
