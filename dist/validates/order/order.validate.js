...
exports.validate_checkin_picked_order = exports.validate_search_order_for_user = exports.validate_search_order = exports.validate_create_order = void 0;
...
const schema_checkin_picked_order = joi_1.default.object({
    id: joi_1.default.string(),
    user_id: joi_1.default.string().required(),
...
const validate_checkin_picked_order = (data) => {
    return schema_checkin_picked_order.validate(data);
};
exports.validate_checkin_picked_order = validate_checkin_picked_order;
