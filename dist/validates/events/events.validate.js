...
exports.validate_get_event_with_position = exports.validate_update_events = exports.validate_create_events = void 0;
...
const schema_create_events = joi_1.default.object({
    ...
    date_start: joi_1.default.date().iso().required().messages({
        'date.format': 'Date must be in ISO 8601 format (yyyy-mm-dd)',
    }),
    date_end: joi_1.default.date().iso().required().messages({
        'date.format': 'Date must be in ISO 8601 format (yyyy-mm-dd)',
    }),
...
const schema_get_events_with_position = joi_1.default.string().required();
...
const validate_get_event_with_position = (position) => {
    return schema_get_events_with_position.validate(position);
};
exports.validate_get_event_with_position = validate_get_event_with_position;
